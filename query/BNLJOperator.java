...
class BNLJOperator extends JoinOperator {
    ...
    private class BNLJIterator extends JoinIterator {
         ...
         */
        private void fetchNextLeftBlock() throws NoSuchElementException {
            // TODO(hw3_part1): implement
            this.leftRecordIterator = BNLJOperator.this.getBlockIterator(
                this.getLeftTableName(), this.leftIterator, BNLJOperator.this.numBuffers - 2);
            ...
            BNLJOperator.this.getPageIterator(this.getRightTableName()).next();
        }
         ...
         */
        private void fetchNextRightPage() throws NoSuchElementException {
            // TODO(hw3_part1): implement
            this.rightRecordIterator = BNLJOperator.this.getBlockIterator(
                this.getRightTableName(), this.rightIterator, 1);
        ...
        private void fetchNextRecord() {
            ...
            do {
                if (this.rightRecord != null) {
                    ...
                    DataBox rightValue = this.rightRecord.getValues().get(BNLJOperator.this.getRightColumnIndex());
